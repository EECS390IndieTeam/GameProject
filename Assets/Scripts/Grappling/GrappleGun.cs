...
public class GrappleGun : MonoBehaviour {
    ...
    public AudioSource grappleAttachedSource;
    public AudioSource grappleFireSource;
    public AudioSource grappleDetachSource;
    ...
    public void fire() {
        ...
        if (grappleHitInfo.collider && !grappleHitInfo.collider.gameObject.GetComponent<Rigidbody>()) {
            ...
            // sound
            grappleFireSource.Play();
            grappleAttachedSource.Play(); // loops
        }
    ...
    public void detach() {
        ...
        Debug.Log("detach grapple");
        grappleAttachedSource.Stop();
        grappleDetachSource.Play();
    }
